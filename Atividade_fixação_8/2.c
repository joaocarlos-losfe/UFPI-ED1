...
int main()
{
	...
	do
	{
		...
		case 5:
			...
			{
				printf("\nNenhum dos vizinhos � mais velho\n");
			}
...
void menu()
{
	...
	printf("\n 3 - crie uma outra lista contendo somente as pessoas que est�o depois dela na fila");
	printf("\n 4 - Devolver uma lista ordenada contendo somente as pessoas menores do que uma idade informada");
	printf("\n 5 - devolva a idade do vizinho mais velho desta pessoa e devolva tamb�m se ele � mais velho do que a pessoa informada\n > ");
}
